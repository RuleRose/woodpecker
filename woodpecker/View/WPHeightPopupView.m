...
@interface WPHeightPopupView()<UIPickerViewDataSource,UIPickerViewDelegate>
@property (nonatomic, strong) UIPickerView *pickerView;
@property (nonatomic, strong) UIView *markView;

@end

@implementation WPHeightPopupView
- (instancetype)init
{
    self = [super init];
...
- (void)confirmBtnPressed{
    [self hide];
    NSInteger height = [_pickerView selectedRowInComponent:0];
    if (_heightBlock) {
        _heightBlock(self, height);
    }
}
/*
