...
- (void)layoutSubviews
{
    ...
    _bottomBorder.frame = CGRectMake(0, _contentView.fs_height-weekdayHeight-weekdayMargin*2, _contentView.fs_width, 0);
    _titleLabel.frame = CGRectMake(25, _bottomBorder.fs_bottom-titleHeight-weekdayMargin, titleWidth - 50,titleHeight);
