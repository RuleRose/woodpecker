...
@implementation NotificationConst
...
NSString* const WPNotificationKeyLogout = @"WPNotificationKeyLogout";
NSString* const WPNotificationKeyVersion = @"WPNotificationKeyVersion";
