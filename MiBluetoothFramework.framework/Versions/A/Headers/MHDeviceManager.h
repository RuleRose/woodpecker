 ...
 */
-(void)fetchNewDeviceWith:(NSString*)ssid withBssid:(NSString*)bssid  withDeviceMac:(NSString*)deviceMac DeviceListBlock:(void(^)(MHDevices* deviceList))deviceList failure:(void(^)(NSError* error))failure;
